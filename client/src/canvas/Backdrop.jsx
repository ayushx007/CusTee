...
const Backdrop = () => {
  ...
  return (
    ...
    frames={60}//60fps
    alphaTest={0.9}//sets the transparency of the shadows
    scale={2}
    rotation={[Math.PI / 2, 0, 0]}
    position={[0, 0, -0.14]}
    >
      <RandomizedLight amount={4} radius={9} intensity={0.6} position={[5,5,-10]} />
      <RandomizedLight amount={4} radius={5} intensity={0.25} position={[-5,5,-9]} />
      <RandomizedLight amount={4} radius={5} intensity={0.25} position={[-5,-5,-9]} />
    </AccumulativeShadows>
  )
}
